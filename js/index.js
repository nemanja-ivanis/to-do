	...
	*/
	...
	$('button#add').on('click',function(){
		...
		if(new_task==='') {
			...
			localStorage.setItem("task-"+storage_increment, JSON.stringify(task_value));
      ...
      $('ul#all').append(new_item);
      $('ul#incomplete-tasks').append(new_item);
		...
		if(parent.hasClass('editMode')){
			...
			$('.inputTask').keyup(function(e) {
				if(e.keyCode == 13)
				{
					...
					localStorage.setItem(task_id,JSON.stringify(updated_value));
